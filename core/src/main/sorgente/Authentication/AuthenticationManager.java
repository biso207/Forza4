...
Gestisce la grafica e logica dell'autenticazione
...
public class AuthenticationManager extends ScreenAdapter implements ResourceLoader
{
    ...
    // costruttore
    public AuthenticationManager(Main game) {
        this.game = game;
